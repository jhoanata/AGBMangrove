...
Bioclimatic data were extracted from the WorldClim Bioclim \citep{Hijmans2005} 30 arc-second data set (http://www.worldclim.org/bioclim). Vegetation condition data consisted of the Enhanced Vegetation Index values extracted from the MOD13Q1 MODIS Vegetation Indices Product. The product represents 16-day composites at 232 m spatial resolution. We selected EVI over the Normalized Difference Vegetation Index, also included in the MOD13Q1 product because it offers better sensitivity to forest canopy variations, specially in areas with high biomass (Huete et al 2002. \marginpar{Huete, A., K. Didan, T. Miura, E. P. Rodriguez, X. Gao, and L. G. Ferreira. 2002. Overview of the radiometric and biophysical performance of the MODIS vegetation indices. Remote Sensing of Environment 83:195-213.}
\end{comment}) over Likewise, global MODIS vegetation indexes provide consistent spatial and temporal comparisons of vegetation conditions; in this sense, EVI values were retrieved from the online data pool, courtesy of the NASA Land Processes Distributed Active Archive Center (LP DAAC) \citep{MODIS2015} (https://lpdaac.usgs.gov/data\_access/data\_pool). 
